...
while user_input != 'x':
    ...
    if user_input_c == user_input_b:
        ...
        while user_input_a != 'x':
            ...
            new_aircraft = Aircraft(aircraft_number='', capacity=int(5), age=int())
            ...
            print('capacity: ', new_aircraft.get_capacity())
            while user_input_ab is not None:
                new_ticket = Tickets(aircraft_number='', capacity=int(), age=int(), ticket_price='',
